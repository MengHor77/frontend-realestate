...
const RentInquiriesForm = ({ property, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const finalSubject = inquiry.subject || `Inquiry about ${property.title} (Rent)`;
        ...
        const payload = {
            ...
            property_type: property.listing_type || 'rent'
        };
        ...
        try {
            ...
            console.error('Error sending rent inquiry:', err);
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
                ...
                <div style={styles.formGroup}>
                    ...
                    <input
                        type="text"
                        name="subject"
                        placeholder={`e.g., Interested in renting ${property.title}`}
                ...
                <div style={styles.formGroup}>
                    ...
                    <textarea
                        name="message"
                        placeholder="Please provide details about your rental inquiry..."
                        rows="4"
...
export default RentInquiriesForm;