...
const ManageNews = () => {
  ...
  const handleOpenCreateModal = () => {
    ...
    setShowCreateModal(true);
    if (setIsOverlayVisible) setIsOverlayVisible(true);
  };
  ...
  const handleCloseModals = () => {
    setShowCreateModal(false);
    setShowEditModal(false);
    if (setIsOverlayVisible) setIsOverlayVisible(false);
  };
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan="7" style={{ textAlign: 'center', padding: '50px' }}>
                    <FontAwesomeIcon icon={faSpinner} spin style={{ fontSize: '32px', color: '#003366' }} />
                    <p>Loading...</p>
                  </td>
                </tr>
              ) : news.length === 0 ? (
